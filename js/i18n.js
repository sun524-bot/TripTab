...
const TRANSLATIONS = {
  en: {
    ...
    calcNoDirectExpenses: 'No expenses paid by',
    calcNoDirectExpenses2: 'for',
    calcNoOffsetExpenses: 'No expenses paid by',
    // PDF / Print report
    printReportTitle: 'Calculation Breakdown Report',
    printPays: 'pays',
    printPaidFor: 'paid for',
    printDeduct: 'Deduct',
    printDirectPairwiseNet: 'Direct Pairwise Net:',
    printExpensesPaidBy: 'Expenses paid by',
    printShareLabel: "'s share",
    ...
    showSplits: 'Show Split Details',
    showSplitsDesc: "View everyone's share for each expense",
    sharedEquallyByAll: 'Shared by all {count} members ({currency} {perPerson} each)',
    sharedEquallyBySome: 'Shared by {count} members ({currency} {perPerson} each)',
    customSplitSummary: 'Custom split among {count} members',
  ...
  zh: {
    ...
    calcPaidBySection: '支付了',
    calcDeductSection: '扣除：由',
    calcShareLabel: '应分担的费用',
    calcNoDirectExpenses: '',
    calcNoDirectExpenses2: '没有为',
    calcNoOffsetExpenses2: '支付任何费用。',
    calcNoOffsetExpenses: '',
    // PDF / Print report
    printReportTitle: '结算计算报告',
    printPays: '需支付给',
    printPaidFor: '为',
    printPaidFor2: '支付了',
    printDeduct: '扣除',
    printDirectPairwiseNet: '点对点净余额：',
    printExpensesPaidBy: '由',
    printExpensesPaidBy2: '支付的费用',
    printShareLabel: '应分担的费用',
    removeMemberTitle: '移除成员',
    createTripBtn: '+ 新建',
    activeTripsCount: '{count} 个进行中的行程',
    splitEquallyAmongText: '在所有 {count} 位成员间平均分摊 — 每人 {currency} {perPerson}',
    showSplits: '显示分摊详情',
    showSplitsDesc: '查看每笔支出的具体分摊情况',
    sharedEquallyByAll: '所有 {count} 位成员均分（每人 {currency} {perPerson}）',
    sharedEquallyBySome: '{count} 位成员均分（每人 {currency} {perPerson}）',
    customSplitSummary: '{count} 位成员按需分摊',
